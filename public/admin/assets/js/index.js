...
document.getElementById('btcCoin').innerHTML = '';
var btcCoinChart = new ApexCharts(document.querySelector("#btcCoin"), options);
btcCoinChart.render();
function btcCoin() {
  btcCoinChart.updateOptions({
    chart: {
      dropShadow: {
        color: "rgb(" + myVarVal + ")",
      }
...
var statisticsChart = new ApexCharts(document.querySelector("#marketCap"), options);
...
(function () {
  ...
  document.getElementById('popTrades').innerHTML = '';
